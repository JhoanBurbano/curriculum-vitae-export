  ...
  return (
    <article className="flex h-full flex-col overflow-hidden rounded-2xl border border-[var(--accent)]/30 bg-[var(--surface)] shadow-[0_0_0_1px_rgba(204,255,0,0.05),0_16px_40px_rgba(0,0,0,0.28)]">
      <div className="border-b border-[var(--border)] bg-[var(--bg)]/50 px-5 py-4">
        {pack.badge && (
          <span className="text-[10px] font-bold uppercase tracking-[0.22em] text-[var(--accent-ink)]">{pack.badge}</span>
        )}
      ...
      <div className="flex flex-1 flex-col gap-4 px-5 py-4">
        ...
        <div className="rounded-lg border border-[var(--warning-border)] bg-[var(--warning-bg)] p-3">
          <p className="text-[10px] font-semibold uppercase tracking-wide text-[var(--warning-ink)]">Cotización</p>
